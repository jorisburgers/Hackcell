...
\begin{document}
	...
	In listing \ref{listing:datatypes} all the data types that are used in the core can be found. \textit{Spreadsheet} is used to initialize the \textit{HackcellState}. The \textit{HackcellState} saves the expressions and results of all the fields. It also contains a function \textit{app}, where all the functions that can be used in the spreadsheet should be defined. 
